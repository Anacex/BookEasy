        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Connecting customers with local service providers for seamless appointment booking. 
              From barbers to tutors, mechanics to beauty professionals - book your next service with ease.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">support@bookeasy.com</span>
              </div>
              <div className="flex items-center space-x-3">
